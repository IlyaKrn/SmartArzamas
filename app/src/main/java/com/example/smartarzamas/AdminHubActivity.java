...
public class AdminHubActivity extends FirebaseActivity {
    ...
    private ImageButton btMenu, btProfile;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        AdminHubNavigationCommon.setUser(user);
        binding = ActivityAdminHubBinding.inflate(getLayoutInflater());
        setContentView(binding.getRoot());
        BottomNavigationView navView = findViewById(R.id.nav_view);
        // Passing each menu ID as a set of Ids because each
        // menu should be considered as top level destinations.
        AppBarConfiguration appBarConfiguration = new AppBarConfiguration.Builder(R.id.navigation_admin_home, R.id.navigation_admin_dashboard, R.id.navigation_notifications).build();
