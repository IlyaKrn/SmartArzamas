...
public class AdminAllChatsFragment extends AdminHubNavigationCommon {
    ...
    protected void addHubActivityCallback() {
        AdminHubActivity.setAllChatsActivityCallback(new AdminHubActivityCallback() {
            @Override
    ...
    protected void init(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        AdminHubNavigationCommon.currentNavigationFragment = ALL_CHATS;
